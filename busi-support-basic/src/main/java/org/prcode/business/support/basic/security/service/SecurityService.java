...
public class SecurityService implements ISecurityService {
    ...
    public CustomerUserDetail getUserDetailByName(String username, Integer accountType) {
    ...
    @CacheDuration
    public List<Role> getUserRoleList(String username, Integer accountType) {
    ...
    public List<CustomerUrlRoles> getUrlRoles() {
        return securityDao.getUrlRoles();
    }
}
